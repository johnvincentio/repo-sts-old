...
<body>
	<a href="user?mylocale=en">English </a> |
	<a href="user?mylocale=de">German </a>
	<h3>
	...
	<table>
		<form:form action="save" method="post" commandName="user">
			...
			<tr>
				<td colspan=2><spring:message code="user.submit"
						var="valSubmit"></spring:message> <input type="submit"
					value="${valSubmit}"></td>
			</tr>
		</form:form>
	</table>
