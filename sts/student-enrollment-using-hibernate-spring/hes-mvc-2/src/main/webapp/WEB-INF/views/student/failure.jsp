...
<body>
	...
	<div class="panel panel-danger">
		...
		<div class="panel-body">
			<div class="alert alert-dismissable alert-danger">
				...
				<strong>Oh snap!</strong> Something is wrong. Change a few things up and try submitting again.
			</div>
		</div>
	</div>
	<div></div>
	...
	<a class="btn btn-primary" href="<spring:url value="student/login"/>">Try again?</a>
</body>
</html>